...
namespace CharacterCreator2D.UI
{
    public class UIPartColor : MonoBehaviour
    {
        ...
        /// </summary>
        [Tooltip("Current state of UIPartColor")] [ReadOnly]
        public UIPartColorState state;

        /// <summary>
        ///     Current mode of UIPartColor.
        /// </summary>
        [Tooltip("Current mode of UIPartColor")] [ReadOnly]
        public UIPartColorMode mode;

        /// <summary>
        ///     SlotCategory displayed by this UIPartColor.
        /// </summary>
        [Tooltip("SlotCategory displayed by this UIPartColor")] [ReadOnly]
        ...
        private void Update()
        {
            ...
            {
                var selectedcolor = _uicreator.colorUI.selectedColor;
        ...
        {
            var c = _uicreator.character.GetPartColor(SlotCategory.Hair, ColorCode.Color1);
        ...
        {
            var c = _uicreator.character.SkinColor;
            _uicreator.character.SetPartColor(slotCategory, ColorCode.Color1, c);
            refreshImgColors();
        }

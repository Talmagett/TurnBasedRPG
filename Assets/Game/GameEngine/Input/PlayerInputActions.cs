...
//     version 1.8.2
//     from Assets/Game/GameEngine/Input/PlayerInputActions.inputactions
//
...
public partial class @PlayerInputActions: IInputActionCollection2, IDisposable
{
    ...
    ~@PlayerInputActions()
    {
        Debug.Assert(!m_Map.enabled, "This will cause a leak and performance issues, PlayerInputActions.Map.Disable() has not been called.");
        Debug.Assert(!m_Battle.enabled, "This will cause a leak and performance issues, PlayerInputActions.Battle.Disable() has not been called.");

...
{
    public class BossSorcerer : EnemyAI
    {
        [SerializeField] private AbilityConfig dealDamageAbility;
        [SerializeField] private AbilityConfig lightningAbility;
        ...
        public override void Run()
        {
            ...
            {
                _counter = 0;
                EventBus.RaiseEvent(new CastAbilityEvent(CharacterEntity, target, lightningAbility));
            }
        }
    }
}
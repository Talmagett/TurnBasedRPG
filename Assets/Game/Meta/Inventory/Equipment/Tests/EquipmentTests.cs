...
//
// namespace Modules.Items.Scripts.Equipment.Tests
// {
//     [TestFixture]
...
//         {
//             var windBoots = new Item.Item(WindBoots, ItemFlags.EQUIPPABLE | ItemFlags.EFFECTIBLE,
//                 new Stats(DamageStat, 10),
//                 new Stats(SpeedStat, 5),
//                 new EquipmentTypeComponent(EquipmentType.LEGS)
//             );
//
//             var electricBoots = new Item.Item(ElectricBoots, ItemFlags.EQUIPPABLE | ItemFlags.EFFECTIBLE,
...
//             );
//
//             var fireSword = new Item.Item(FireSword, ItemFlags.EQUIPPABLE | ItemFlags.EFFECTIBLE,
//                 new Stats(DamageStat, 32),
//                 new EquipmentTypeComponent(EquipmentType.RIGHT_HAND)
//             );
//
//             var iceShield = new Item.Item(IceShield, ItemFlags.EQUIPPABLE | ItemFlags.EFFECTIBLE,
//                 new Stats(HealthStat, 24),
//                 new EquipmentTypeComponent(EquipmentType.LEFT_HAND)
//             );
//
//             var plateMail = new Item.Item(PlateMail, ItemFlags.EQUIPPABLE | ItemFlags.EFFECTIBLE,
//                 new Stats(HealthStat, 56),
//                 new EquipmentTypeComponent(EquipmentType.BODY)
//             );
//
//             var divineHelmet = new Item.Item(DivineHelmet, ItemFlags.EQUIPPABLE | ItemFlags.EFFECTIBLE,
